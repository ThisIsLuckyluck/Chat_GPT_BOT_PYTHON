The program is working using python on discord, so you have to create your bot in the developer portal and then get the token of the discord bot to put it on the program.
